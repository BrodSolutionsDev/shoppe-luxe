...
export default class ProductDetails extends ProductDetailsBase {
    ...
    pdpFancyboxScript() {                
        ...
        const getAllImgs = () =>{
            ...
            if($(".productView-img-container",this.$scope).hasClass("slick-initialized")){
                mainImageUrl = $(".productView-img-container .slick-active",this.$scope).attr("href");                            
            }else{
                mainImageUrl = $(".productView-img-container a",this.$scope).attr("href");                            
            }

            currentMainImage = mainImageUrl.split("/");

            $(".productView-thumbnail",this.$scope).each((i,elmnt)=>{
                let opt = {}
        ...
        $(".productView-img-container",this.$scope).on("click",(event) =>{
            ...
            if( $(".productView-img-container.slick-initialized",this.$scope).length > 0) {
